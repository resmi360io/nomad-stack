  ...
  // ─── USD → Philippines (PHP) ───────────────────────────────────────────────
  {
    ...
    providers: [
      ...
      },
      {
        ...
        available: true,
        notes:
          'Available, familiar, and the most expensive mainstream way to receive client money in the Philippines. Cross-border commercial receiving runs about 4.4% plus a fixed fee, and converting the USD balance to pesos adds a currency spread of roughly 3-4% (we could not open PayPal\'s Philippine fee page directly, so treat the exact percentages as estimates and check your own transaction receipts). PayPal links directly to GCash. GCash\'s published cash-in fee schedule puts PayPal cash-ins at free up to PHP 8,000 a month, with 2% on anything above that, and PHP 8,000 is a low ceiling for invoice-sized payments, so expect the 2% to apply. We could not open GCash\'s help pages from our side to confirm the schedule or when it took effect, so check the fee the app quotes you. A flat 1% figure dated 7 March 2026 circulates on Philippine finance blogs, but it appears to describe linked bank account cash-in rather than PayPal, so we do not carry it. Settlement still takes about 1-2 business days. Use PayPal when a client insists on it; move recurring clients to Wise or Payoneer.',
      },
      {
        slug: 'western-union',
        name: 'Western Union',
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'PayPal and GCash have a direct link: connect your GCash account in PayPal, withdraw, and the money typically lands within 1-2 business days. Most of the cost sits earlier in the chain, where PayPal charges about 4.4% plus a fixed fee to receive a cross-border commercial payment and then applies a 3-4% spread when converting USD to pesos, so roughly 8% is gone before GCash is involved. On the GCash side, its published cash-in fee schedule puts PayPal cash-ins at free up to PHP 8,000 a month with 2% above that: under the allowance the cash-in step costs nothing and the all-in stays near 8%, above it you are closer to 10%. PHP 8,000 is a low monthly ceiling for invoice-sized payments, so plan on the 2%. We could not open GCash\'s help pages from our side to confirm the schedule, so check the fee the app quotes before you withdraw. A flat 1% figure dated 7 March 2026 circulates on Philippine finance blogs; it appears to describe linked bank account cash-in rather than PayPal, so we do not use it here.',
      },
      {
