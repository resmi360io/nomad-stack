  ...
  // USD to India (INR)
  {
    ...
    providers: [
      ...
      },
      {
        ...
        available: true,
        notes:
          'Available, familiar, and the most expensive thing on this page. Commercial receiving is 4.40% plus a fixed fee, thirty cents on dollars, and then 3.0% above the base exchange rate when the money is converted. To receive at all you have to verify your PAN, add an Indian bank account and pick a purpose code, which PayPal walks you through. The paperwork is better than the price: a weekly digital FIRA is free and fully automated, and a transaction-specific one costs 100 rupees plus GST, requested through Citibank and taking three to five business days if you bank with Citi and seven to ten if you do not. One thing worth knowing rather than worrying about. We checked the Reserve Bank public register of authorised cross-border payment aggregators, as published on 8 September 2026, and PayPal is not on it. There is a straightforward explanation, and we should have found it the first time: PayPal announced in May 2025 that it had received in-principle approval from the Reserve Bank to operate as a cross-border payment aggregator for exports, and an in-principle holder does not appear on the register until the full authorisation comes through. Payoneer is in exactly the same position, having announced its own in-principle approval in January 2026. So this is a status rather than an accusation, and it applies to two of the providers on this page rather than to PayPal alone.',
      },
      {
        slug: 'skydo',
        name: 'Skydo',
    ...
    faqs: [
      ...
      },
      {
        ...
        a:
          'Check the Reserve Bank own register. Since the cross-border payment aggregator framework came in, companies that collect export payments for Indian sellers need a specific authorisation, and the RBI publishes the list of who holds one. It is short, it is public, and checking it takes a minute. When we looked at the version published on 8 September 2026, Wise Payments India Private Limited was on it, and so were Skydo, Xflow and BriskPe under their corporate names. Revolut Payments India Private Limited is on the same document too, but as a prepaid payment instrument issuer rather than a cross-border aggregator, which is the licence its section below describes. Karbon, Winvesta and Infinity were not on it at all. Neither were PayPal or Payoneer, and there is a straightforward reason: both have announced in-principle approval from the Reserve Bank, PayPal in May 2025 and Payoneer in January 2026, and an in-principle holder does not appear on this list until the full authorisation is granted. We should be explicit that Wise pays us a commission and Wise is on the register, so if that had gone the other way you would be entitled to wonder whether we would have mentioned it. Be careful what you conclude from an absence: the register covers one specific authorisation and a company can be operating perfectly legally under a different arrangement, which is why we flag PayPal absence rather than making an accusation of it. But if you are about to route serious money through a rail you had not heard of last week, the register is the first place to look.',
      },
      {
